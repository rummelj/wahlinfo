...
public class VoteGenerator implements IVoteGenerator {
	...
	while (true) {
		...
		votes.add(new CsvGeneratedVote(id++, year, aggregation.getElectoralDistrictId(), partialAggregations[dirVotesIndex].getPartyName(),
			partialAggregations[listVotesIndex].getPartyName()));
	    }
	}
	return votes;
    }
